# OpenCLI 来源与兼容映射候选：DEV.to latest articles
...
- 选中命令：`devto latest`；注册 `columns` 仅作字段线索。
- `third_party/opencli-1.8.8/clis/devto/latest.js` — upstream SHA-256 `6b7290772a6f0c22bcbfc3b6da1f331c42d0c58bbb636ab9e1840b274f527302`
...
- Completeness is scoped to the requested page response. It does not claim that the entire latest-article feed was fetched; the adapter does not consume a continuation link or total count.
