...
EXPECTED_OPERATION_DETAILS = {
    "xhs_publish_note_precheck": {
        "target_kind": "creator_publish_entrypoint",
        "page_fact": "snapshot.creator_publish_entrypoint.available",
        "visible_fields": ["upload_image_entry", "text_image_entry"],
...
def mutation_cases() -> dict[str, Callable[[dict[str, Any]], None]]:
    mutations: dict[str, Callable[[dict[str, Any]], None]] = {
        ...
        "missing_field_source_ref": lambda value: value["entries"][0]["field_sources"]["required_fields"].__setitem__("upload_image_entry", []),
        ...
        "unknown_source_kind": lambda value: value["entries"][0]["field_sources"]["required_fields"]["upload_image_entry"].append("unknown_summary"),
