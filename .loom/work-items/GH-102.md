...
- Out of scope: WebEnvoy Core code changes, Core result envelope schema, runtime execution, live source or evidence lookup, Harbor/App code, hosted registry, marketplace, sync service, crawler queue, benchmark contract, write guardrail behavior, true write capability, merge, or issue closeout.
