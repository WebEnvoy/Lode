...
- Current Stop: GH-99 branch `work/GH-99-local-package-resolution` is implementing repo-local package resolution through `registry/local-packages.json` and validator consumption.
