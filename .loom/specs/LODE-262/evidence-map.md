...
| EV-002 | test_evidence | tools/validate_runtime_consumption_allowlist.py | Exact lock/origin/mode/resource/failure/evidence/post-check binding and five fail-closed mutations | LODE-262 offline validator | present | Test evidence covers only Lode static assets. | Rerun after any allowlist or bound package asset change. |
