...
| Capability 可选结果视图兼容声明、锁定与标准 renderer 回退 | [Optional result-view declaration](result-view-declaration.md) |
...
站点 SKILL 的文件布局和本地修改保留边界由 Site SKILL Package V1 承接；最低作者/导入流程见配套指南。未纳入 contracts：public contribution review / marketplace distribution、完整 personal asset storage / sync / complex overlay/fork conflict management、App Library UX、Reports UX、其他 package 类型的文件布局、runner、schedule、visual builder、hosted registry。
...
| `docs/draft/personal-assets.md` | 有。个人资产不应覆盖平台资产本体，应通过 overlay/fork/draft；私有 normalizer patch / source schema patch / private fixture 有独立需求，这些判断仍有效。 | [ADR 0004](../adr/0004-asset-types-and-registry.md) 吸收 platform/personal asset 共用 type vocabulary、overlay/fork/draft 和 local registry version identity；最低 site-SKILL 草稿/导入流程见 [Site asset authoring/import V1](site-asset-authoring-import-v1.md) 与 WebEnvoy #508 S3 小节。 | 私有资产存储、team sync、active/deprecated/archive 状态、App 操作、导出/提交贡献、复杂 overlay/fork 冲突管理仍 deferred；复杂冲突由 [PD-0012](../adr/pending-decisions.md#pd-0012) 承接。 |
